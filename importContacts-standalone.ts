...
function roleParser(labelNameObject, listOfEmails) {
    let compRoles: string[] = [];
    let isTrainer: string[] = [];
    // Position Strings: First is the tested for value, second is the readable output one.
    let ap: string[] = ["(AP)", "AP"];
    let zl1: string[] = ["(ZL1)", "ZL1"];
    let zl2: string[] = ["(ZL2)", "ZL2"];
    let zl3: string[] = ["(ZL3)", "ZL3"];
    let stl1: string[] = ["(STL1)", "STL1"];
    let stl2: string[] = ["(STL2)", "STL2"];
    let stl3: string[] = ["(STL3)", "STL3"];
    let dl: string[] = ["(DL)", "DL"];
    let seniorComp: string[] = ["(SC)", "SC"];
    let juniorComp: string[] = ["(JC)", "JC"];
    let seniorCompTrainer: string[] = ["(TR)", "TR"];
    let zlTrainer: string[] = ["(ZLT)", "ZLT"];
    let stlTrainer: string[] = ["(STLT)", "STLT"];
    let dlTrainer: string[] = ["(DT)", "DT"];
    let specialAssignment: string[] = ["(SA)", "SA"];
